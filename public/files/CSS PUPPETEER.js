...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección I. Instrumentos</td>
        </tr>
        <tr style="width: 100%; ">
        ...
        <tr style="width: 100%; ">
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: start;  width: 11%;" class="seccion1columnssllenar" >
            <div style=" display: flex; flex-direction: column;">
              <div style="border-bottom: 1px solid #A6A6A6;" >
              <label ><input type="radio"  name="estado">Cualitativa</label>
              </div>

              <div>
              <label ><input type="radio"  name="estado">Cuantitativa</label>
              </div>
            </div>
            </td>
            <td style="text-align: center; width: 9%; " class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" ></td>
            <td style="text-align: center; width: 10%;" class="seccion1columnssllenar" >
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección II. Procedimientos</td>
        </tr>
        <tr style="width: 100%; ">
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 10px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección III. Metodologías de estimación</td>
        </tr>
        <tr style="width: 100%; ">
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="11" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección IV. Calendario del programa de Detección y Reparación de Fugas</td>
        </tr>
        <tr style="width: 100%; ">
        ...
        <tr style="width: 100%; ">
            ...
            <div style="height: auto; display: flex; flex-direction: column; width: 100%;">
              <div style="height: 50%; display: flex; flex-direction: column; ">
                ...
                <div style="border-bottom: 1px solid #A6A6A6; padding-bottom: 4px; padding-top: 4px;">
                <label ><input type="radio" style=" margin-right: 2px;" name="estado">No</label>
                </div>
              </div>
...
<tbody id="tabla-body" style="width: 100%; font-size: 11px; background-color: #ffffff; border-color: #A6A6A6;  ">
  <tr style="filasseccionIV" >
    ...
    <ol type="I" start="1" >
      ...
      <li style="padding-top: 5px;">Sección V: Documentos anexos al formato
        <ol type="a" style=" padding-top: 5px; padding-bottom: 0px; ">
